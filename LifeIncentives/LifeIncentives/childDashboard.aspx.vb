Public Class childDashboard
    ...
    Protected Sub BTNViewrequest_Click(sender As Object, e As ImageClickEventArgs)

    End Sub

    Protected Sub btnsendPInc_Click(sender As Object, e As EventArgs)

    End Sub

    Protected Sub btnsendPDec_Click(sender As Object, e As EventArgs)

    End Sub

    Protected Sub btnsendGInc_Click(sender As Object, e As EventArgs)

    End Sub

    Protected Sub btnsendGdec_Click(sender As Object, e As EventArgs)
