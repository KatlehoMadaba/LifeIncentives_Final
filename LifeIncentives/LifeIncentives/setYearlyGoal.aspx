<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="setYearlyGoal.aspx.vb" Inherits="LifeIncentives.Webform1" %>
        ...
        <div style="max-width:800px">
            <div class="setGoalsCard">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <asp:Label ID="Label8" runat="server" Text="Year" CssClass="lbl-text"></asp:Label>
                        <div class="form-group">
                    ...
                    <div class="col-md-6 text-center" style="font-size:18px; font-weight:bold;color:#007BFF">
                        <asp:Label ID="lblTotalAmount" runat="server" style="font-size:30px;font-family:Quicksand,'Source Sans Pro';color:#013220" />
                    </div>
                ...
                <div class="goals-container table-responsive" style="margin-top:10px">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Description" DataSourceID="SqlDataSource1" CssClass="table table-bordered table-striped">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="EndDateTime" HeaderText="End Date Time" SortExpression="EndDateTime" lass="align-middle" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conn2 %>"
                        SelectCommand="SELECT [StartDateTime], [EndDateTime], [Category], [Description], [TimePeriod], [Amount], [Status] FROM [TBL_Set_Goals] WHERE [Status] = @Status AND YEAR([StartDateTime]) = @Year"
