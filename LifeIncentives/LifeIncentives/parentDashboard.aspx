...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="group-20127-nbW" id="407:1682">
            <div class="group-20125-WnQ" id="407:1683">   
                <div class="group-20118-FV6" id="407:1684">
                    ...
                    <div class="auto-group-dr1n-3fr" id="AX3e7JhoCx88YWkojDDR1N">
                        ...
                        <p class="r50-6PE" id="407:1693">R<asp:Label ID="Label1" runat="server"></asp:Label></p>
                        <%--<img class="group-zDi" src="Dimg/parentIcon.png" id="407:1694" />--%>
                        <asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnIncParent_Click" data-toggle="modal" data-target="#myModal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <!-- Submit button inside the modal -->
                                <asp:Button ID="Button1" runat="server" OnClick="btnsubPInc_Click" Text="Send"/>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        </div>
                    </div>
                </div>
                         </div>
                        <asp:LinkButton ID="LinkButton2" runat="server" OnClick="btnDecParent_Click" data-toggle="modal" data-target="#myModal2">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <!-- Submit button -->
                         <asp:Button ID="Button2" runat="server" OnClick="btnsubPDec_Click" Text="submit"/>
    ...
    <asp:LinkButton ID="LinkButton3" runat="server" OnClick="btnSendRequest_Click" CssClass="set-daily-goals-EXN">
  ...
  <%--      <div class="set-daily-goals-EXN" id="I407:1715;155:1825">--%>
     ...
     <%--   </div>--%>
    <asp:LinkButton ID="LinkButton4" runat="server" OnClick="btnViewRequests_Click" CssClass="set-daily-goals-6Lc">
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6">
            <div class="progressCircle blue">
                ...
                <div class="progressCircle-value"><asp:Label ID="Label2" runat="server" Text ="90%"></asp:Label></div>
            </div>
        </div>
</div>
        </div>
        ...
        <div class="katleho-A4t" id="407:1738"><asp:Label runat="server" ID="Label3" /></div>
        <div class="item-123-TJt" id="407:1739"><asp:Label runat="server" ID="Label4"/></div>
            ...
            <div class="group-20125-dFJ" id="416:1371">
                <div class="group-20118-Zek" id="416:1372">
                    ...
                    <div class="auto-group-sqme-Pdn" id="AX3fN27dwZD5Wvz8fDsqmE">
                        ...
                        <p class="r50-qVn" id="416:1383">R<asp:Label ID="Label5" runat="server" Text="50"></asp:Label></p>
                        ...
                        <div class="group-Uoe" id="416:1415">
                            ...
                            <asp:LinkButton ID="LinkButton5" runat="server" OnClick="btnIncGov_Click" data-toggle="moodal" data-target="#myModal4">
                            ...
                            <div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <!-- Submit button -->
                                            <asp:Button ID="Button3" runat="server" OnClick="btnsubGInc_Click" Text="Submit"/>
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <asp:LinkButton ID="LinkButton6" runat="server" OnClick="btnDecGov_Click" data-toggle="modal" data-target="#myModal5">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                 ...
                                 <asp:TextBox ID="TextBox4" runat="server" ></asp:TextBox>
                                    ...
                                    <div class="modal-footer">
                                        <!-- Submit button -->
                                       <asp:Button ID="Button4" runat="server" OnClick="btnsubGDec_Click"  Text="submit"/>
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    </div>
                                </div>
                            </div>
